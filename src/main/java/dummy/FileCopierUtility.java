	...
	private void buildGUI() {
		...
		DocumentListener listener = new DocumentListener() {
			...
			public void removeUpdate(DocumentEvent e) {
				// boolean bEnabled = txtSource.getText().length() > 0 &&
...
//		panInputFields.add(txtTarget, BorderLayout.CENTER);
	...
	public void actionPerformed(ActionEvent e) {
		if ("Copy".equals(btnCopy.getText())) {
			File source = new File("C:\\Users\\HDMI\\Downloads\\tokens\\test\\Picture1_3300.png");
			File target = new File("C:\\Users\\HDMI\\Downloads\\tokens\\Picture1_33000.png");
